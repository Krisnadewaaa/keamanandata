...
@section('title', 'Profil Pegawai Gudang')

@section('content')
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Profil Pegawai Gudang</h1>
        <a href="{{ route('gudang.edit') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card bg-light mb-3">
                        <div class="card-body">
                            <div class="text-center">
                                <div class="h5 font-weight-bold">Total Barang</div>
                                <div class="h1 mb-0 font-weight-bold text-primary">{{ $totalBarang }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card bg-light mb-3">
                        <div class="card-body">
                            <div class="text-center">
                                <div class="h5 font-weight-bold">Stok Minimum</div>
                                <div class="h1 mb-0 font-weight-bold text-warning">{{ $barangMinimum }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if ($pegawai->TANGGAL_LAHIR)
                        <form action="{{ route('gudang.profile.update-password-dob') }}" method="POST">
                            @csrf
                    ...
                    @else
                        ...
                        <a href="{{ route('gudang.edit') }}" class="btn btn-warning">Edit Profil</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-tasks mr-1"></i> Menu Cepat
            </h6>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <a href="{{ route('gudang.stok') }}" class="btn btn-block btn-primary mb-2">
                        <i class="fas fa-boxes mr-1"></i> Kelola Stok Barang
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="{{ route('gudang.stok.tambah') }}" class="btn btn-block btn-success mb-2">
